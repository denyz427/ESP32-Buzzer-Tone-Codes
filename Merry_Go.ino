...
//"Merry Go" by Kevin MacLeod https://www.youtube.com/watch?v=f5Tatbs1WxY https://incompetech.com/music/royalty-free/index.html?isrc=USUAN1100731&Search=Search
int melody [][2]={
                   {NOTE_G5,250},{0,0},{NOTE_G5,125},{0,0},{NOTE_G5,125},{0,0},{NOTE_FS5,250},{0,0},{NOTE_G5,250},{0,0},{NOTE_A5,250},{NOTE_G5,250},{NOTE_G5,500},{0,0}
                  ,{NOTE_G5,250},{0,0},{NOTE_F5,250},{0,0},{NOTE_F5,500},{0,0},{NOTE_G5,250},{0,0},{NOTE_F5,250},{0,0},{NOTE_F5,500},{0,0}
                  ,{NOTE_G5,250},{0,0},{NOTE_G5,125},{0,0},{NOTE_G5,125},{0,0},{NOTE_FS5,250},{0,0},{NOTE_G5,250},{0,0},{NOTE_A5,250},{NOTE_G5,250},{NOTE_G5,500},{0,0}
                  ,{NOTE_G5,250},{0,0},{NOTE_G5,250},{0,0},{NOTE_F5,250},{0,0},{NOTE_E5,250},{0,0},{NOTE_D5,250},{0,0},{NOTE_C5,250},{0,0},{NOTE_C5,500},{0,0}
                  ,{NOTE_G5,250},{0,0},{NOTE_G5,125},{0,0},{NOTE_G5,125},{0,0},{NOTE_FS5,250},{0,0},{NOTE_G5,250},{0,0},{NOTE_A5,250},{NOTE_G5,250},{NOTE_G5,500},{0,0}
                  ,{NOTE_G5,250},{0,0},{NOTE_F5,250},{0,0},{NOTE_F5,500},{0,0},{NOTE_G5,250},{0,0},{NOTE_F5,250},{0,0},{NOTE_F5,500},{0,0}
                  ,{NOTE_G5,250},{0,0},{NOTE_G5,125},{0,0},{NOTE_G5,125},{0,0},{NOTE_FS5,250},{0,0},{NOTE_G5,250},{0,0},{NOTE_A5,250},{NOTE_G5,250},{NOTE_G5,500},{0,0}
                  ,{NOTE_G5,250},{0,0},{NOTE_G5,250},{0,0},{NOTE_F5,250},{0,0},{NOTE_E5,250},{0,0},{NOTE_D5,250},{0,0},{NOTE_C5,250},{0,0},{NOTE_C5,500},{0,0}
                  ,{NOTE_GS4,250},{NOTE_GS5,500},{0,0},{NOTE_GS5,250},{0,0},{NOTE_G5,500},{0,0},{NOTE_G5,500},{0,0}
                  ,{NOTE_GS4,250},{NOTE_GS5,500},{0,0},{NOTE_GS5,250},{0,0},{NOTE_G5,500},{0,0},{NOTE_G5,500},{0,0}
                  ,{NOTE_C5,250},{NOTE_C6,500},{0,0},{NOTE_C6,250},{0,0},{NOTE_C6,500},{0,0},{NOTE_B5,500},{0,0}
                  ,{NOTE_C6,500},{0,0},{NOTE_B5,500},{0,0},{NOTE_C6,500},{0,0},{0,500}
                 };
